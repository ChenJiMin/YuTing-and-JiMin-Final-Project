...
st.write('The following two plots illustrate the effectiveness of the model. The less difference between the actual and the predicted, the better your model works.')
